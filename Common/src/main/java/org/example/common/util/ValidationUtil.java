...
public class ValidationUtil {
  ...
  public static <T extends Enum<T>> String validateEnum(
  ...
  public static String validatePerson(Person person) {
    ...
    if (Double.isNaN(person.getHeight())
        || Double.isInfinite(person.getHeight())
        || person.getHeight() <= 0) {
  ...
  public static float validateFloat(String value, String fieldName)
      throws IllegalArgumentException {
    try {
