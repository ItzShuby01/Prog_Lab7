...
public class ServerCommandManager implements CommandExecutable {
    ...
    // This map stores instances of server-side command handlers for easy access to their descriptions and execution logic.
    ...
    private void initializeCommands() {
        ...
        registerServerCommand("average_of_height", cmd -> {
            try {
        ...
        registerServerCommand("register", cmd -> registerCmd.execute((RegisterCommand) cmd), registerCmd);
