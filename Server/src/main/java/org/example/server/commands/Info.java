...
public class Info implements ServerCommand{
    ...
    public Response execute(InfoCommand commandDto) {
        ...
        infoBuilder.append("Initialization Date: ").append(collectionManager.getCreationDate()).append("\n");
        infoBuilder.append("Number of persons in collection: ").append(collectionManager.getSize());
